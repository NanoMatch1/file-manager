...
def pad_files(fileDir, padLength: 3, padChar: str):
    ...
    for folder in folders:
        ...
        print(f'{len(fileList)} files renamed in {workingDir}.')
    # print(f'All files renamed in {fileDir}.')
...
def load_and_edit_files(filepath, header=None):
    ...
    for folder in folders:
        ...
        for file in fileList:
            ...
            # newData = [x for x in newData if len(x) > 1]
...
# def generate_temperature_lists(filepath):
#     '''generate lists of temperatures for each file in the directory'''
#     folders = [file for file in os.listdir(filepath)]
...
#             # breakpoint()
#         with open(os.path.join(workingDir, 'temperature_list.txt'), 'w') as f:
...
if __name__ == '__main__':
    ...
    # filepath = r'C:\Users\sjbrooke\OneDrive - The University of Melbourne\Data\Maria\TDF\Temperature Dependence_final\5%Nd-NC@shell_785'
    filepath = r'C:\Users\sjbrooke\OneDrive - The University of Melbourne\Data\Maria\TDF-4\808 export_baselined'
    filepath = r'C:\Users\sjbrooke\OneDrive - The University of Melbourne\Data\Maria\temp_profile_2'
    # filepath = r'C:\Users\sjbrooke\OneDrive - The University of Melbourne\Data\Maria\TDF-3\5%Nd-NC@shell_785'
    # preprocess_files(filepath)



    # move_files_ABC(filepath)
    # # rename_files(filepath, None, 'LnNP')D
    rename_files(filepath, 'hp_test_1_5mw_1s_30s', 'hp-test-1-5mw-1s-30s')
    # rename_basename(filepath, 'LnNP')
    # pad_files(filepath, 3, '0')
    # # breakpoint()
    # load_and_edit_files(filepath, header=['data_type', 'maria'])